...
local f = assert(io.open("c:\\Users\\anton\\Documents\\новая папка\\myfile.txt", "r"))
local data = f:read("*all")
print(data)
f:close()

local f = assert(io.open("c:\\Users\\anton\\Documents\\новая папка\\newfile.txt", "a"))
f:write(data)
f:close()
